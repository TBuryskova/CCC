...
clustered_se <- cluster.vcov(length_proceeding, data_cleanCE$chamber_id)
clustered_se_C <- cluster.vcov(length_proceeding_C, data_cleanCE$chamber_id)

# Repeat for the other models
clustered_se_outcome <- cluster.vcov(outcome, data_cleanCE$chamber_id)
clustered_se_outcome_C <- cluster.vcov(outcome_C, data_cleanCE$chamber_id)

clustered_se_cpy <- cluster.vcov(cited_per_year, data_cleanCE$chamber_id)
clustered_se_cpy_C <- cluster.vcov(cited_per_year_C, data_cleanCE$chamber_id)
